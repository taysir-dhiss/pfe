            ...
            {appointments.length === 0 ? (
              ...
              <tr key={a._id} className="hover:bg-brand-50 transition">
                ...
                <td className="py-3 px-4">
                  <span className={`badge text-xs flex items-center gap-1 w-fit ${a.reminderSent ? "bg-green-50 text-green-600" : "bg-gray-100 text-gray-700"}`}>
                    {a.reminderSent && <CheckCircleIcon className="w-3 h-3" />}
